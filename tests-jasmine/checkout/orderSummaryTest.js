...
describe('test suite: renderOrderSummary', () => {
  ...
  it('updates the delivery option', () => {
    ...
    expect(
      document.querySelector(`.js-delivery-option-inpit-${productId1}-3`)
    ).checked;
    ...
    expect(
      document.querySelector('.js-total-row').innerText
    ).toContain('$63.50')
  })
})